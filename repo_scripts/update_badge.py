...
def main() -> None:
    ...
    gist_id = os.environ.get("GIST_ID", "783bbd51dbf2fbbf28ef680536c42671")
    repo_name = os.environ.get(
        "GITHUB_REPOSITORY", "vroomfondel/flickrtoimmich"
    )  # needs full repo-name with username e.g. vroomfondel/flickrtoimmich

    history_filename = "flickrtoimmich_clone_history.json"
    badge_filename = "flickrtoimmich_clone_count.json"
